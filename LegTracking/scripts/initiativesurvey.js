...
function initiativeSurveyListViewDataShow(e)
{
    ...
    var apiUrl = "http://dev1.pciaa.net/pciwebsite/congressapi/legislators/legislatorsurveys?legislatorId=" + legislatorId + "&initiativeId=" + initiativeId + "&active=Y";
        ...
        (
            {
                filter: ">li",
                enableSwipe: true,
                touchstart: initiativeSurveyTouchStart,
                tap: initiativeSurveyNavigate,
                swipe: initiativeSurveySwipe
            }
        );
...
function initiativeSurveySwipe(e)
{
